      ...
      <div className="flex-1 min-w-0 space-y-1.5">
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="text-[13px] font-medium rounded-lg border border-border/40 bg-muted/30 px-2 py-0.5 text-foreground cursor-pointer focus:outline-none focus:ring-2 focus:ring-ring/40 disabled:opacity-50"
          >
            {options.map((cat) => (
